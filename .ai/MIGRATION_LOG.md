...
- Добавить `data-i18n` во все статические тексты на всех страницах
- Заполнить `locales/uk.json` (украинский язык)
- Добавить UI переключателя языков (флаги)
- Протестировать переключение без перезагрузки
